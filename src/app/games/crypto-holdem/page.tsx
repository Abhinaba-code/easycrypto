...
import { Hand, Loader2, ChevronsLeft, LogIn, RefreshCw } from 'lucide-react';
...
export default function CryptoHoldemPage() {
  ...
  const renderGameContent = () => {
    if (!user) {
      return (
        <div className="text-center space-y-4">
          <p className="text-lg text-muted-foreground">Log in to play Crypto Hold'em!</p>
    ...
    return (
        <div className="text-center space-y-4">
            <p className="text-2xl font-bold">Texas Hold'em</p>
            <p className="text-muted-foreground">Click 'Deal' to see who wins the hand.</p>
    ...
    <div className="container py-12 flex flex-col items-center gap-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-4xl font-headline">Crypto Hold'em</CardTitle>
          <CardDescription>A classic game of Texas Hold'em with a crypto twist.</CardDescription>
        </CardHeader>
