...
import { Target, Loader2, ChevronsLeft, LogIn, RefreshCw } from 'lucide-react';
...
export default function BullseyeBetsPage() {
  ...
  const renderGameContent = () => {
    if (!user) {
      return (
        <div className="text-center space-y-4">
          <p className="text-lg text-muted-foreground">Log in to play Bullseye Bets!</p>
    ...
    return (
        <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">Click 'Throw' to try your luck.</p>
    ...
    <div className="container py-12 flex flex-col items-center gap-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-4xl font-headline">Bullseye Bets</CardTitle>
          <CardDescription>Hit the target to win a prize.</CardDescription>
        </CardHeader>
