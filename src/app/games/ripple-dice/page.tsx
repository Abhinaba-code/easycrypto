...
export default function RippleDicePage() {
  ...
  const renderGameContent = () => {
    if (!user) {
      return (
        <div className="text-center space-y-4">
          <p className="text-lg text-muted-foreground">Log in to play Ripple Dice!</p>
    ...
    return (
        <div className="text-center space-y-4">
            <p className="text-2xl font-bold">Roll a 4+ to win!</p>
    ...
    <div className="container py-12 flex flex-col items-center gap-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-4xl font-headline">Ripple Dice</CardTitle>
          <CardDescription>Roll a 4 or higher to win!</CardDescription>
        </CardHeader>
