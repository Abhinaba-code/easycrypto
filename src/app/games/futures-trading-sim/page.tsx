...
import { CandlestickChart, Loader2, ChevronsLeft, LogIn, RefreshCw } from 'lucide-react';
...
export default function FuturesTradingSimPage() {
  ...
  const renderGameContent = () => {
    if (!user) {
      return (
        <div className="text-center space-y-4">
          <p className="text-lg text-muted-foreground">Log in to play the Futures Trading Sim!</p>
    ...
    return (
        <div className="text-center space-y-4">
            <p className="text-2xl font-bold">Long or Short?</p>
            <p className="text-muted-foreground">Predict the market direction.</p>
    ...
    <div className="container py-12 flex flex-col items-center gap-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-4xl font-headline">Futures Trading Sim</CardTitle>
          <CardDescription>Go long or short on the market. Test your trading instincts.</CardDescription>
        </CardHeader>
