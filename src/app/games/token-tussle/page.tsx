...
export default function TokenTusslePage() {
  ...
  const renderGameContent = () => {
    if (!user) {
      return (
        <div className="text-center space-y-4">
          <p className="text-lg text-muted-foreground">Log in to play Token Tussle!</p>
    ...
    return (
        <div className="text-center space-y-4">
            <p className="text-2xl font-bold">Token Tussle</p>
            <p className="text-muted-foreground">Click 'Tussle' to see which token wins.</p>
    ...
    <div className="container py-12 flex flex-col items-center gap-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-4xl font-headline">Token Tussle</CardTitle>
          <CardDescription>Pit your token against another. Who will win?</CardDescription>
        </CardHeader>
